...
2. My [digital fork](https://github.com/alnihill/Digital)
  > Clone the repo, then run ``mvn install -DskipTests`` (~~The tests should pass, they just take a while..~~ The tests *do not* currently pass because I don't feel like updating the translation files until I'm done with what I'm working on.) 
